...
class MblNewseventImportService extends AbstractImportJob {
	...
	/**
	 * @param integer $wordpressUid
	 * @return array
	 */
	public function getNewsRecordByImportId($wordpressUid) {
		return $this->databaseConnection->exec_SELECTgetSingleRow('uid', 'tx_news_domain_model_news', 'import_id=' . (int)$wordpressUid);
	}
