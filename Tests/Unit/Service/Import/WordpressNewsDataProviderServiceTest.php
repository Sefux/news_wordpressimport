<?php
namespace Projektkater\NewsWordpressimport\Tests\Service\Import;
...
/**
 * Test class for \Projektkater\NewsWordpressimport\Service\Import\WordpressNewsDataProviderService
 *
 * @package TYPO3
 * @subpackage news_wordpressimport
 */
class WordpressNewsDataProviderServiceTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function relatedLinksAreParsedCorrectly($given,$expected) {
		$mockTemplateParser = $this->getAccessibleMock('Projektkater\\NewsWordpressimport\\Service\\Import\\WordpressNewsDataProviderService', array('dummy'));
