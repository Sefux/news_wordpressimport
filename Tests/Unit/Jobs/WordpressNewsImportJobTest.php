<?php
namespace Projektkater\NewsWordpressimport\Tests\Unit\Jobs;
 ...
 */
class WordpressNewsImportJobTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	public function getNumberOfRecordsPerRunReturnsExpectedValue() {
		$jobInstance = new \Projektkater\NewsWordpressimport\Jobs\WordpressNewsImportJob();
